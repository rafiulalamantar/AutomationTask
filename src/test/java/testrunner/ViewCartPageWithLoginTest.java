...
public class ViewCartPageWithLoginTest extends TestBase {
    HomePage homePage;
    ...
    public ViewCartPageWithLoginTest() {
    ...
    @Test(priority = 1)
    public void verifyClickOnProceedToCheckOutButton() throws InterruptedException, IOException, ParseException {
